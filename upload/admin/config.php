<?php
// HTTP
define('HTTP_SERVER', 'http://opencart/html/upload/admin/');
define('HTTP_CATALOG', 'http://opencart/html/upload/');

// HTTPS
define('HTTPS_SERVER', 'http://opencart/html/upload/admin/');
define('HTTPS_CATALOG', 'http://opencart/html/upload/');
